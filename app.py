...
Exact model metrics from notebook (wine_quality_prediction_eng_feat.ipynb):
  ...
  F1 Score  : 0.710
  AUC-ROC   : 0.951
  Avg Prec  : 82.77% (from notebook cell 31)
...
st.markdown("<p style='text-align: center; color: #5c4a3a; font-family: \"Lato\", sans-serif; font-size: 1.05rem; font-style: italic; margin-top: 1.5rem; margin-bottom: 0.5rem; padding: 0 1.2rem;'>A predictive enology dashboard using machine learning and 5 chemically engineered features to identify premium red wine profiles.</p>", unsafe_allow_html=True)
    ...
    with col_result:
        ...
        if "last_prob" in st.session_state:
            ...
            if st.session_state.get("show_explanation", False):
                ...
                st.markdown('<p class="sec-sub">Importance &times; scaled value.</p>', unsafe_allow_html=True)
...
with tab_method:
    ...
    <div class="meth-grid">
      ...
      <div class="meth-card">
        ...
        &mdash; atypical for quality dry reds. Correlation: <strong>&minus;0.03</strong>.</div>
