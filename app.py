...
.direction-good  { color: #4a7c59; font-size: 0.7rem; margin-top: 0.3rem; }
.direction-bad   { color: #8b1a2f; font-size: 0.7rem; margin-top: 0.3rem; }
.direction-range { color: #7a6a30; font-size: 0.7rem; margin-top: 0.3rem; }
...
@media (min-width: 768px) {
    ...
    .meth-grid { grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); }
...
@media (max-width: 480px) {
    ...
    .top-bar-meta { font-size: 0.55rem; }
    .stTabs [data-baseweb="tab"] { padding: 0.6rem 0.7rem; font-size: 0.65rem; }
    .input-panel-title { font-size: 0.9rem; }
    ...
    with col_result:
        ...
        if predict_btn:
            ...
            <div style="background:#fff;border:1px dashed #d0c8c0;border-radius:12px;
                        padding:1.5rem 1rem;text-align:center;color:#c8bdb8;font-size:0.8rem;margin-bottom:1rem;">
...
with tab_method:
    ...
    <br>
    <div style="font-size:0.7rem;color:#9b8c84;line-height:1.5;">
...
# ═══════════════════════════════════════════════════════════════════════
# TAB 3 — MODEL INSIGHTS (responsive grid)
# ═══════════════════════════════════════════════════════════════════════
with tab_insights:
    st.markdown('<div class="tab-content">', unsafe_allow_html=True)
